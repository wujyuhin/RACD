...
class Net(nn.Module):
    ...
    def __init__(self, knowledge_n, exer_n, student_n):
        ...
        self.student_emb_new = nn.Embedding(self.emb_num, self.stu_dim)
    ...
    def forward(self, stu_id, input_exercise, input_knowledge_point):
        ...
        stu_emb_new = self.student_emb_new(stu_id)
        ...
        new_knowledge_point = torch.sigmoid(stu_emb_new)
        # prednet
        input_x = e_difficulty * (stat_emb - k_difficulty) * input_knowledge_point
        # input_x = e_difficulty *(stat_emb * new_knowledge_point -  k_difficulty * input_knowledge_point)
...
class NCDM(CDM):
    ...
    def train(self, train_data, test_data=None, epoch=10, device="cpu", lr=0.002, silence=False, save_dir=None):
        since = time.time()
            ...
            if test_data is not None:
                ...
                if accuracy > bestAccuracy:
                    ...
                    if save_dir is not None:
                        self.save(os.path.join(save_dir, 'best_ncdm.pth'))
                    else:
                        self.save('best_ncdm.pth')
